...
%\ShowFrame
	...
	\begin{VCPicture}{(-4,-2.5)(4,9.5)}
		...
		\State[7]{(0,-2)}{7} 			  
		\Initial[w]{S}
		\ArcL{S}{0}{\overline{x_1 x_2}/y}
		\ArcR{S}{4}{\overline{x_1 x_2}/\overline{y}}	
...
\begin{figure}[bt]
	...
	%\ShowFrame
	\VCDraw{
		\begin{VCPicture}{(-4,-3.5)(4,11.5)}
			\SetEdgeLabelScale{1.4}
			\StateVar[0:\overline{x_1 x_2} y]{(-3,8)}{0}
			\StateVar[1:x_1 x_2 y]{(0,10)}{1}
			\StateVar[2:x_1 \overline{x_2} y]{(3,8)}{2}
			\StateVar[3:\overline{x_1} x_2 y]{(0,6)}{3} 
			\StateVar[4:\overline{x_1 x_2 y}]{(-3,0)}{4}			
			\StateVar[5:x_1 x_2 \overline{y}]{(0,2)}{5}
			\StateVar[6:x_1 \overline{x_2} \overline{y}]{(3,0)}{6}
			\StateVar[7:\overline{x_1} x_2 \overline{y}]{(0,-2)}{7}   			  
			\Initial[n]{0}
			\Initial[n]{4}
			\LoopW{0}{}
...
\begin{figure}[bt]
	...
	\caption{Strategy to the realizable version}
...
\begin{figure}[bt]
	...
	\caption{Synchronous composition of the strategy with the minimization}
