...
%technical text
The quantitative results of our experiments are shown in tables 
...
\begin{table*}
	\resizebox{\textwidth}{!} {
\input{../experimental_setting/tmp_results/experimental_compared_data_liveness.tex}
}
...
\begin{table*}
	\resizebox{\textwidth}{!} {
		\input{../experimental_setting/tmp_results/experimental_compared_data_safety.tex}
	}
