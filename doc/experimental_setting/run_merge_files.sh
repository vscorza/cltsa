...
tail -q -n +2 lift_controller_2.fsp.csv collector_1_in_v1.fsp.csv exploration-robot-v1_100.fsp.csv ahb_arbiter_2_sched.fsp.csv genbuf_1_sndrs_no_automaton.fsp.csv CM_1.fsp.csv >> realizable_data_composite.csv
