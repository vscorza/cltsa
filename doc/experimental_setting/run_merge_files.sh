...
tail -q -n +2 lift_controller_2.fsp.csv lift_controller_4.fsp.csv lift_controller_6.fsp.csv lift_controller_8.fsp.csv  collector_1_in_v1.fsp.csv exploration-robot-v1_100.fsp.csv exploration-robot-v1_200.fsp.csv exploration-robot-v1_300.fsp.csv exploration-robot-v1_400.fsp.csv exploration-robot-v1_500.fsp.csv exploration-robot-v1_600.fsp.csv ahb_arbiter_2_sched.fsp.csv genbuf_1_sndrs_no_automaton.fsp.csv >> realizable_data_composite.csv
