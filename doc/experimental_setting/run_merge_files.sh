...
tail -q -n +2 lift_controller_2_missing_assumption.fsp.csv collector_1_in_v1_missing_assumption.fsp.csv exploration-robot-v1_6_missing_assumption.fsp.csv genbuf_1_sndrs_no_automaton_missing_assumption.fsp.csv genbuf_1_sndrs_no_automaton_removed_env_safety.fsp.csv >> unrealizable_data_composite.csv
tail -q -n +2 lift_controller_2.fsp.csv  collector_1_in_v1.fsp.csv exploration-robot-v1_6.fsp.csv genbuf_1_sndrs_no_automaton.fsp.csv >> realizable_data_composite.csv
