...
#over_10000 <- times_table[times_table$plant_transitions >= 10000,]
#mean(over_10000$reduction * 100)
#mean(over_10000$minimization_transitions)
#over_1000 <- times_table[times_table$plant_transitions >= 1000,]
#mean(over_1000$reduction * 100)
#mean(over_1000$minimization_transitions)
#over_100 <- times_table[times_table$plant_transitions >= 100,]
#mean(over_100$reduction * 100)
#over_200 <- times_table[times_table$plant_transitions >= 200,]
#mean(over_200$reduction * 100)
...
# Sequentialization of CLTS structures
...
```{r echo=FALSE}
ggplot(table_seq_composite_game_no_robot, aes(x=trans_times_mean_signals_vs_seq_states, y=trans_vs_states)) +
...
ggplot(table_seq_composite_game_no_robot, aes(x=1/states_ratio, y=trans_vs_states)) +
