...
table_seq_composite_game_no_robot <- subset(seq_composite_game_no_robot, select = c(filename, states_count, seq_states, states_ratio, transitions_count, seq_transitions, transitions_ratio, mean_delta_s, mean_signals_t))
...
kable(table_seq_composite_game_no_robot, caption = "Concurrent vs seq", col.names=c("Specification","#States","#Seq. states","#States/#Seq. states", "#Transitions", "#Seq. trans", "#Trans/#Seq, Trans","Mean out(s)","Mean signals per trans."))
```
...
```{r echo=FALSE}
#, col.names=c("Specification","Diagnosis(s)","Liveness fluents", "Plant transitions", "Min. transitions","Minimization pct.(%)","Min. steps")
table_intrlvd_composite_game_no_robot <- subset(seq_composite_game_intrlvd_conform_no_robot, select = c(filename, states_count, intrlvd_states, states_ratio, transitions_count, intrlvd_transitions, transitions_ratio, mean_delta_s, mean_signals_t))
...
kable(table_intrlvd_composite_game_no_robot, caption = "Concurrent vs interleaved", col.names=c("Specification","#States","#Intrlvd. States","#States/#Intrlvd. States", "#Transitions","#Intrlvd. Trans", "#Trans/#Intrlvd. Trans","Mean out(s)","Mean signals per trans."))
```
