...
\begin{definition} 
	\label{def:synchronous_composition}(\emph{Synchronous Composition}) Let \cltsDefIdx{M},\cltsDefIdx{N}, with $\Delta_M : S_M \times 2^{|\Sigma_M|} \times S_M$, be two CLTS instances, then CLTS synchronous parallel composition is defined as \cltsComposition{M}{N}{s} where:\\
