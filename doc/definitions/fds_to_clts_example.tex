...
\begin{figure}[bt]
	...
	%\centering
	\VCDraw{
		\begin{VCPicture}{(-6.5,-1.5)(6.5,3.5)}
			\SetStateLabelScale{1}
			\SetEdgeLabelScale{1.2}
			\StateVar[(s_0, 0):\overline{r g_1 g_2}]{(-6,2.9)}{0}
			\StateVar[(2, 0):\overline{r g_1} g_2 ]{(-2,2.9)}{1}
			\StateVar[(6,1):r g_1\overline{g_2}]{(2,2.9)}{2}
			\StateVar[(5.0):r \overline{g_1}g_2]{(6,2.9)}{3}
			\StateVar[(1,0):\overline{r g_1}g_2]{(6,-0.3)}{4}
			\StateVar[(2,1):\overline{r g_1} g_2]{(2,-0.3)}{5}				
			\Initial[w]{0}
			\LoopS{1}{}
			\EdgeL{0}{1}{}        
			\EdgeL{1}{2}{}        						
