...
\newcommand{\propositions}{\ensuremath{\mathbb{P}}}
\newcommand{\proposition}{\ensuremath{p}}
...
\newcommand{\fdsDef}{$\fdsD = \langle \gsV,$ $\theta,$ $\rho,$ $\mathcal{J},$ $\mathcal{C}\rangle$\xspace}
...
\newcommand{\fdsEmbedding}{\ensuremath{ltl(\controlProblem) = \fdsControlProblem' =\langle \gsX,$ $\gsY,$ $\varphiLTL \rangle}\xspace}
