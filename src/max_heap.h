...
#define GET_MAX_HEAP_ARRAY_ENTRY(heap, array, index)                           \
  ((void *)(((char *)array) + (index * heap->sizeof_element)))
#define GET_MAX_HEAP_ENTRY(heap, index)                                        \
  ((void *)(((char *)heap->values) + (index * heap->sizeof_element)))
#define GET_MAX_HEAP_L_CHILD(heap, x)                                          \
  GET_MAX_HEAP_ENTRY(heap, MAX_HEAP_L_INDEX(x))
#define GET_MAX_HEAP_R_CHILD(heap, x)                                          \
  GET_MAX_HEAP_ENTRY(heap, MAX_HEAP_R_INDEX(x))
#define GET_MAX_HEAP_PARENT(heap, x)                                           \
  GET_MAX_HEAP_ENTRY(heap, MAX_HEAP_PARENT_INDEX(x))
