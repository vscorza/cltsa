...
$sys_transitions .= "//This guarantee is added to make the specification unrealizable\n";
$sys_transitions .= "ltl sys rho G_wst_a in GENBUF\t = [](!enq && !slc0 && !bToR_REQ0 && !bToR_REQ1).\n";
###############################################
