...
automaton_automata_context *automaton_automata_context_create_from_syntax(automaton_program_syntax *program, char *ctx_name,
                                                                          char *test_name, diagnosis_search_method diagnosis_method,
                                                                          char *results_filename, char *steps_filename, bool append_result);
...
void automaton_indexes_valuation_set_atom_label(automaton_parsing_tables *tables, automaton_indexes_valuation *valuation,
...
void automaton_indexes_valuation_set_to_label(automaton_parsing_tables *tables, automaton_indexes_valuation *valuation,
                                              automaton_indexes_valuation *next_valuation, automaton_indexes_syntax *to_indexes,
...
automaton_fluent *automaton_fluent_create_from_syntax(automaton_parsing_tables *tables, automaton_fluent_syntax *fluent_def_syntax,
                                                      automaton_alphabet *global_alphabet, automaton_indexes_valuation *current_valuations);
...
void automaton_indexes_syntax_eval_strings(automaton_parsing_tables *tables, automaton_indexes_valuation *last_valuation,
                                           automaton_indexes_valuation ***valuations, uint32_t *valuations_count, uint32_t *valuations_size,
