...
automaton_statement_syntax *automaton_statement_syntax_create(
    ...
    ltl_rule_syntax *ltl_rule_def, ltl_fluent_syntax *ltl_fluent_def,
...
automaton_vstates_syntax *
automaton_vstates_syntax_create_from_state(automaton_state_label_syntax *state);
automaton_vstates_syntax *
...
automaton_serialization_syntax *
automaton_serialization_syntax_create_from_ref(char *name, char *automaton_name,
