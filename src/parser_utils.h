...
typedef enum { ASYNCH_AUT, SYNCH_AUT, CONCURRENT_AUT } automaton_synchronization_type_syntax;
/****************
==== STRUCTS ====
*/
...
automaton_statement_syntax *automaton_statement_syntax_create(
    ...
    automaton_gr1_game_syntax *gr1_game_def, ltl_rule_syntax *ltl_rule_def, ltl_fluent_syntax *ltl_fluent_def,
