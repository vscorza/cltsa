...
#define ddHash(f, g, s) ((((unsigned)(ptruint)(f)*DD_P1 + (unsigned)(ptruint)(g)) * DD_P2) >> (s))
#else
...
#define ddCHash(o, f, g, h, s)                                                                                                             \
  ((((((unsigned)(ptruint)(f) + (unsigned)(ptruint)(o)) * DD_P1 + (unsigned)(ptruint)(g)) * DD_P2 + (unsigned)(ptruint)(h)) * DD_P3) >> (s))
#else
#define ddCHash(o, f, g, h, s) ((((((unsigned)(f) + (unsigned)(o)) * DD_P1 + (unsigned)(g)) * DD_P2 + (unsigned)(h)) * DD_P3) >> (s))
#endif

//	Hash function for the cache for functions with two operands.
#if SIZEOF_VOID_P == 8 && SIZEOF_INT == 4
#define ddCHash2(o, f, g, s) (((((unsigned)(ptruint)(f) + (unsigned)(ptruint)(o)) * DD_P1 + (unsigned)(ptruint)(g)) * DD_P2) >> (s))
#else
#define ddCHash2(o, f, g, s) (((((uint64_t)(f) + (uint64_t)(o)) * DD_P1 + (uint64_t)(g)) * DD_P2) >> (s))
#endif
...
#define GET_VAR_IN_VALUATION(arr, variable_count, valuation_index, variable_index)                                                         \
...
obdd_node *obdd_node_restrict_vector(obdd_mgr *mgr, obdd_node *root, uint32_t *var_ids, bool *values, uint32_t current_index,
                                     uint32_t count);
